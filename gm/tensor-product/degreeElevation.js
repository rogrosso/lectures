...
import { tessellation, computePatches, degreeElevationPatches } from 'tpSurfaces'
...
folderGeo.add(guiProps.geometry, 'degreeElevation', 0,maxDegreeElevation,1).name('degree elevation').onChange( updateGeometry )
const geoState = {
...
function updateGeometry() {
    if (geoState.level !== guiProps.geometry.level || geoState.degreeElevation !== guiProps.geometry.degreeElevation) {
